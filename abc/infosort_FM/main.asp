...
<form action="" method="post" name="form1">
  <div id="headPanel">父母类别列表</div>
  <div id="buttonPanel">
    <a class="aButton" href="add.asp">父母类别添加</a>
  </div>
  <div id="contentPanel">
...
<%
		...
		If Not (rsSort.Bof Or rsSort.Eof) Then
			...
			Do While Not (rsSort.Bof Or rsSort.Eof) 
				...
				Response.Write "<td nowrap=""nowrap"" align=""center""><a href='../info/main.asp?infosort_FM_ID=" & lngSortId & "'>" & TdString(strSortName) & "</a></td>" & vbCrLf
