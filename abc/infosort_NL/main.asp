...
<form action="" method="post" name="form1">
  <div id="headPanel">年龄类别列表</div>
  <div id="buttonPanel">
    <a class="aButton" href="add.asp">年龄类别添加</a>
  </div>
  <div id="contentPanel">
...
<%
		...
		If Not (rsSort.Bof Or rsSort.Eof) Then
			...
			Do While Not (rsSort.Bof Or rsSort.Eof) 
				...
				Response.Write "<td nowrap=""nowrap"" align=""center""><a href='../info/main.asp?infosort_NL_ID=" & lngSortId & "'>" & TdString(strSortName) & "</a></td>" & vbCrLf
