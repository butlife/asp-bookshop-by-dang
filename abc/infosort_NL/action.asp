...
<%
	...
	Function Delete()
		...
		strBookSql = "Select * From info_t Where infosort_NL_id = " & lngId & ""
		...
		strSql = "Select * From infosort_NL Where sortid = " & lngId & ""
		...
		strSql = "Delete From infosort_NL Where sortid = " & lngId & ""
		conn.Execute strSql
