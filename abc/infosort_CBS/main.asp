...
<form action="" method="post" name="form1">
  <div id="headPanel">出版社类别列表</div>
  <div id="buttonPanel">
    <a class="aButton" href="add.asp">出版社添加</a>
  </div>
  <div id="contentPanel">
...
<%
		...
		If Not (rsSort.Bof Or rsSort.Eof) Then
			...
			Do While Not (rsSort.Bof Or rsSort.Eof) 
				...
				Response.Write "<td nowrap=""nowrap"" align=""center""><a href='../info/main.asp?infosort_CBS_ID=" & lngSortId & "'>" & TdString(strSortName) & "</a></td>" & vbCrLf
