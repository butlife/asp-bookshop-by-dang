...
<body><form name="form1" method="post" action="Save.asp" onSubmit="return btnSubmit_Click();">
  ...
  <div id="bodyContent">
    ...
    <div class="div">
      <label id="lblContent">内容</label>
		<script type="text/plain" id="s_News" name="s_News" style="width:720px;height:300px;"><%=strcontent%></script>
    </div>
    <div id="SubPanel">
